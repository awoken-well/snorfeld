...
/* src/SplitPanel.svelte generated by Svelte v3.44.3 */

const file$4 = "src/SplitPanel.svelte";
...
function create_fragment$4(ctx) {
	...
	const block = {
		c: function create() {
			...
			attr_dev(div0, "class", "left svelte-mn1oto");
			add_location(div0, file$4, 5, 4, 50);
			attr_dev(div1, "class", "divider svelte-mn1oto");
			add_location(div1, file$4, 8, 4, 118);
			attr_dev(div2, "class", "center svelte-mn1oto");
			add_location(div2, file$4, 9, 4, 150);
			attr_dev(div3, "class", "divider svelte-mn1oto");
			add_location(div3, file$4, 12, 4, 222);
			attr_dev(div4, "class", "right svelte-mn1oto");
			add_location(div4, file$4, 13, 4, 254);
			attr_dev(div5, "class", "container svelte-mn1oto");
			add_location(div5, file$4, 4, 0, 22);
		},
...
function instance$4($$self, $$props, $$invalidate) {
	...
	validate_slots('SplitPanel', slots, ['left','center','right']);
...
class SplitPanel extends SvelteComponentDev {
	constructor(options) {
		super(options);
...
const fragments = derived(files, $files => {
    let __fragments = {};
    Object.values($files).forEach(f => {
        if (!_fragments[f.path] || get_store_value(_fragments[f.path]).lastModified != f.lastModified) {
            let fragment = {
                id: f.path,
...
const selectedFragment = writable(null);

/* src/ListPanel.svelte generated by Svelte v3.44.3 */

const { Object: Object_1$1 } = globals;
const file$3 = "src/ListPanel.svelte";
...
// (15:1) {#each fragmentList as fragment (get(fragment).id)}
function create_each_block(key_1, ctx) {
	let li;
	let t_value = get_store_value(/*fragment*/ ctx[4]).slug + "";
	let t;
	let mounted;
	let dispose;
	...
	const block = {
		...
		c: function create() {
			li = element("li");
			t = text(t_value);
			add_location(li, file$3, 15, 2, 374);
			this.first = li;
		},
		m: function mount(target, anchor) {
			...
			if (!mounted) {
				dispose = listen_dev(
					...
					"click",
					function () {
						if (is_function(/*selectFragment*/ ctx[1](/*fragment*/ ctx[4]))) /*selectFragment*/ ctx[1](/*fragment*/ ctx[4]).apply(this, arguments);
					},
					false,
					false,
					false
		...
		p: function update(new_ctx, dirty) {
			ctx = new_ctx;
			if (dirty & /*fragmentList*/ 1 && t_value !== (t_value = get_store_value(/*fragment*/ ctx[4]).slug + "")) set_data_dev(t, t_value);
		},
		d: function destroy(detaching) {
	...
	dispatch_dev("SvelteRegisterBlock", {
		...
		type: "each",
		source: "(15:1) {#each fragmentList as fragment (get(fragment).id)}",
		ctx
	});
...
function create_fragment$3(ctx) {
	...
	let each_value = /*fragmentList*/ ctx[0];
	validate_each_argument(each_value);
	const get_key = ctx => get_store_value(/*fragment*/ ctx[4]).id;
	...
	const block = {
		c: function create() {
			...
			add_location(ul, file$3, 13, 0, 314);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
		...
		p: function update(ctx, [dirty]) {
			if (dirty & /*selectFragment, fragmentList, get*/ 3) {
				each_value = /*fragmentList*/ ctx[0];
				validate_each_argument(each_value);
				validate_each_keys(ctx, each_value, get_each_context, get_key);
...
function instance$3($$self, $$props, $$invalidate) {
	...
	validate_store(fragments, 'fragments');
	component_subscribe($$self, fragments, $$value => $$invalidate(2, $fragments = $$value));
	validate_store(selectedFragment, 'selectedFragment');
	component_subscribe($$self, selectedFragment, $$value => $$invalidate(3, $selectedFragment = $$value));
	let { $$slots: slots = {}, $$scope } = $$props;
	validate_slots('ListPanel', slots, []);

	function selectFragment(fragment) {
		set_store_value(selectedFragment, $selectedFragment = fragment, $selectedFragment);
	}
	...
	Object_1$1.keys($$props).forEach(key => {
		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console.warn(`<ListPanel> was created with unknown prop '${key}'`);
	});
	...
	$$self.$inject_state = $$props => {
		if ('fragmentList' in $$props) $$invalidate(0, fragmentList = $$props.fragmentList);
	};
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty & /*$fragments*/ 4) {
			$$invalidate(0, fragmentList = Object.values($fragments).sort((a, b) => ('' + get_store_value(a).path).localeCompare(get_store_value(b).path)));
		}
	};

	return [fragmentList, selectFragment, $fragments];
}

class ListPanel extends SvelteComponentDev {
	constructor(options) {
		super(options);
...
/* src/components/codemirror/CodeMirror.svelte generated by Svelte v3.44.3 */

const { Object: Object_1 } = globals;
const file$2 = "src/components/codemirror/CodeMirror.svelte";
...
function create_fragment$2(ctx) {
	...
	const block = {
		c: function create() {
			...
			add_location(div, file$2, 45, 2, 1265);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
...
function instance$2($$self, $$props, $$invalidate) {
	...
	function createEditor(options) {
		...
		$$invalidate(2, editor = codemirror(element, { ...options, value }));
	...
	const writable_props = ['class', 'editor', 'options', 'value'];
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty & /*element, options*/ 18) {
			if (element) {
				createEditor(options);
			}
		}

		if ($$self.$$.dirty & /*editor, value*/ 12) {
			if (editor) {
		...
		if ($$self.$$.dirty & /*editor, options*/ 20) {
			if (editor) {
	...
	return [classes, element, editor, value, options, div_binding];
}
...
class CodeMirror_1 extends SvelteComponentDev {
	constructor(options) {
		...
		if (/*value*/ ctx[3] === undefined && !('value' in props)) {
			console.warn("<CodeMirror> was created without expected prop 'value'");
		}
	}
...
/* src/EditorPanel.svelte generated by Svelte v3.44.3 */

const { console: console_1 } = globals;
const file$1 = "src/EditorPanel.svelte";
...
function create_fragment$1(ctx) {
	...
	function codemirror_editor_binding(value) {
		/*codemirror_editor_binding*/ ctx[5](value);
	}
	...
	if (/*editor*/ ctx[1] !== void 0) {
		codemirror_props.editor = /*editor*/ ctx[1];
	}
	...
	const block = {
		c: function create() {
			...
			attr_dev(div, "class", "mirror svelte-a5yuwr");
			add_location(div, file$1, 25, 0, 586);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
		...
		p: function update(ctx, [dirty]) {
			...
			if (!updating_editor && dirty & /*editor*/ 2) {
				...
				codemirror_changes.editor = /*editor*/ ctx[1];
...
function instance$1($$self, $$props, $$invalidate) {
	...
	Object.keys($$props).forEach(key => {
		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1.warn(`<EditorPanel> was created with unknown prop '${key}'`);
	});
	...
	function div_binding($$value) {
		binding_callbacks[$$value ? 'unshift' : 'push'](() => {
			scrollElement = $$value;
			(((($$invalidate(0, scrollElement), $$invalidate(2, document)), $$invalidate(4, existingDocument)), $$invalidate(1, editor)), $$invalidate(3, scrollState));
		});
	}
	...
	$$self.$inject_state = $$props => {
		if ('document' in $$props) $$invalidate(2, document = $$props.document);
		if ('scrollState' in $$props) $$invalidate(3, scrollState = $$props.scrollState);
		if ('scrollElement' in $$props) $$invalidate(0, scrollElement = $$props.scrollElement);
		if ('existingDocument' in $$props) $$invalidate(4, existingDocument = $$props.existingDocument);
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty & /*document, existingDocument, scrollElement, editor, scrollState*/ 31) {
			{
				console.log('newdoc: ', document);

				if (existingDocument) {
					// update the scroll state in the editor
					$$invalidate(3, scrollState[existingDocument.id] = scrollElement.scrollTop, scrollState);
				}

				if (document) {
					editor.swapDoc(document);
					$$invalidate(0, scrollElement.scrollTop = scrollState[document.id], scrollElement);
					$$invalidate(4, existingDocument = document);
				}
			}
		}
	};
...
class EditorPanel extends SvelteComponentDev {
	constructor(options) {
		super(options);
		init(this, options, instance$1, create_fragment$1, safe_not_equal, { document: 2 });
...
const currentDocument = derived(selectedFragment, $selectedFragment => {
    if (!$selectedFragment) return null

    let fragment = get_store_value($selectedFragment);
...
function create_left_slot(ctx) {
	let listpanel;
	let current;
	listpanel = new ListPanel({ props: { slot: "left" }, $$inline: true });

	const block = {
		c: function create() {
			create_component(listpanel.$$.fragment);
		},
		m: function mount(target, anchor) {
			mount_component(listpanel, target, anchor);
			current = true;
		},
		p: noop,
		i: function intro(local) {
			if (current) return;
			transition_in(listpanel.$$.fragment, local);
			current = true;
		},
		o: function outro(local) {
			transition_out(listpanel.$$.fragment, local);
			current = false;
		},
		d: function destroy(detaching) {
			destroy_component(listpanel, detaching);
		}
	};
...
function create_center_slot(ctx) {
	...
	const block = {
		...
		p: function update(ctx, dirty) {
			...
			if (dirty & /*mainDocument*/ 1) editorpanel_changes.document = /*mainDocument*/ ctx[0];
...
function create_fragment(ctx) {
	...
	const block = {
		c: function create() {
			main = element("main");
			create_component(splitpanel.$$.fragment);
			attr_dev(main, "class", "svelte-4m571o");
			add_location(main, file, 11, 0, 257);
		},
		l: function claim(nodes) {
			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
		},
		m: function mount(target, anchor) {
			...
			mount_component(splitpanel, main, null);
			current = true;
		},
		p: function update(ctx, [dirty]) {
			const splitpanel_changes = {};

			if (dirty & /*$$scope, mainDocument*/ 5) {
		...
		i: function intro(local) {
			if (current) return;
			transition_in(splitpanel.$$.fragment, local);
			current = true;
		},
		o: function outro(local) {
			transition_out(splitpanel.$$.fragment, local);
			current = false;
		},
		d: function destroy(detaching) {
			if (detaching) detach_dev(main);
			destroy_component(splitpanel);
		}
	};
...
function instance($$self, $$props, $$invalidate) {
	...
	component_subscribe($$self, currentDocument, $$value => $$invalidate(1, $currentDocument = $$value));
	let { $$slots: slots = {}, $$scope } = $$props;
	...
	$$self.$inject_state = $$props => {
		if ('mainDocument' in $$props) $$invalidate(0, mainDocument = $$props.mainDocument);
	};
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty & /*$currentDocument*/ 2) {
			$$invalidate(0, mainDocument = $currentDocument);
		}
	};

	return [mainDocument, $currentDocument];
}
